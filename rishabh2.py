...
def update_task():
    try:
        ...
        messagebox.showwarning("Warning","Please select a task to be update!")
...
tk.Button(btn_frame,text="Updated Task",width=10,command=update_task).grid(row=0,column=2,padx=5)
